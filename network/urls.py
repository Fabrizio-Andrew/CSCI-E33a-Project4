...
urlpatterns = [
    ...
    path("posts/<int:pagenumber>", views.get_posts, name="posts"),
    path("posts/<str:username>/<int:pagenumber>", views.get_posts, name="userposts"),
    path("posts/<str:username>/<int:pagenumber>/<int:followflag>", views.get_posts, name="followingposts"),
